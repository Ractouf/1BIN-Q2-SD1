...
public class TestListeSDImpl {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("6 -> Tester la methode insererEnTete()");
			System.out.println("7 -> Tester la methode insererEnQueue()");
			System.out.println("8 -> Tester la methode donnerPrecedent()");
			System.out.println("9 -> Tester la methode donnerSuivant()");
